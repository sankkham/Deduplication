...
<div class="container"  align="center" style="margin-top: 70px">
  <div class="panel panel-default" style="width: 50%">
    <div class="panel-heading"><h4>Check Token For Duplication Here</h4></div>
    <div class="panel-body">
    <form action="Token_check" method="post">
        <div class="form-group" align="left">
            <input type="text" name="token" value="" placeholder="Enter Received Token Here" class="form-control" autocomplete="off" required >
        </div>
        <div align="left">
