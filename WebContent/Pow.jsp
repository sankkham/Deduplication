...
<head>
	...
	<title>Proof Of Ownership Page</title>
...
<div class="container"  align="center" style="margin-top: 90px">
  ...
  <div class="panel panel-default" style="width: 50%">
    <div class="panel-heading"><h4>Prove Your Ownership To get File Path Here</h4></div>
    <div class="panel-body">
    <form action="Proof.jsp">
        <div class="form-group" align="left">
            <input type="text" name="identity" value="" placeholder="Enter Your Mail ID Here" class="form-control" autocomplete="off" required >
        </div>
        <div align="left">
        <input type="submit" class="btn btn-success" value="Prove">
