...
%>
 <TR>
              ...
              <TD> <a href="keycheck.jsp?filename=<%=resultset.getString(2)%>&path=<%=resultset.getString(4)%>"><button type="button" class="btn btn-info">Download</button></a></TD>
              <TD> <a href="Request_keyservlet?filename=<%=resultset.getString(2)%>&ownername=<%=resultset.getString(5)%>"><button type="button" class="btn btn-info">Request Key</button></a></TD>
           </TR>
<% 
   } 
